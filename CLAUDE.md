# Vytte — Claude Code Master Instructions
...
**Builder:** Isaac Jootar (solo founder). Claude Code is the engineering team.
...
| Database | PostgreSQL (dev AND production/VPS — never SQLite) |
...
**CURRENT PHASE: Module 01 — Foundation**
