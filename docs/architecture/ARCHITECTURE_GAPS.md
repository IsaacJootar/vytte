...
| AG-43 | Completed results are immutable/reproducible | Presentation and scoring are frozen for template assessments; final report rendering is still generated from live report views | Content/admin, responses, reporting | High | Persist the structured report snapshot at completion | Assessment/scoring resolved; report pending |
