<x-app-layout title="Projects">
    ...
    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Each project holds one assessment target — a health facility, community, clinic, or programme — and every assessment you run on it.</p>
        </div>
    ...
    {{-- Search bar --}}
    <form method="GET" action="{{ route('projects.index') }}" class="mb-5 flex gap-2" data-no-loading>
