<x-admin-layout title="Facility Profile">
    ...
    <form method="POST" action="{{ route('admin.facility-profiles.update', $profile) }}" class="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-800">
        @csrf
        @method('PUT')
