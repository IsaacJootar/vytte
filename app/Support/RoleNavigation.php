            ...
            'groups' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        self::item('admin.assessment-oversight.index', 'Activity', 'inbox-stack', 'admin.assessment-oversight.*'),
                ...
                [
                    ...
                    'items' => [
                        ...
                        self::item('admin.audit-logs.index', 'Audit Log', 'wrench-screwdriver', 'admin.audit-logs.*'),
                    ],
                ],
            ],
            'mobile' => [
