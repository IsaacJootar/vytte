    ...
    public function frameworkPayload(DepartmentFrameworkVersion $version, int $displayOrder = 1, ?string $areaLabel = null): array
    {
        ...
        $questions = $placements->map(function ($placement) use ($itemRules) {
            ...
            return [
                ...
                'section_instructions' => $placement->section?->instructions,
                'section_estimated_minutes' => $placement->section?->estimated_minutes,
                'section_respondent_role' => $placement->section?->respondent_role,
                'section_is_repeatable' => (bool) $placement->section?->is_repeatable,
